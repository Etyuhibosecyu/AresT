...
public class AdaptiveHuffmanDec : AresTLib007.AdaptiveHuffmanDec
{
	...
	public AdaptiveHuffmanDec(Decoding decoding, ArithmeticDecoder ar, List<byte> skipped, LZData lzData, int lz, int bwt, int n, int counter, bool hfw) : base(decoding, ar, skipped, lzData, lz, bwt, n, counter, hfw) => this.decoding = decoding;
